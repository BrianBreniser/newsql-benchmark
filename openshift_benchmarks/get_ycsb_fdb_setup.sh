...
# Get ycsb setup
ycsbsetup=$(cat 'ycsb_statefulset.yaml' | grep 'read_modify_write_proportion\|update_proportion\|read_proportion\|insert_proportion\|num_keys\|value_size_bytes\|batch_size\|num_clients\|threads_per_process\|process_per_host\|max_execution_time_seconds\|seq\|phase')
